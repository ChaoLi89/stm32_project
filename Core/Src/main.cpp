...
//  MX_DMA_Init();
  ...
  const char* msg = "hello from chao dma\n\r";
  ...
  //HAL_UART_Receive_DMA(&huart4, rx_buffer, 100);
  while (1)
  {
    /* USER CODE END WHILE */
	...
	//  HAL_UART_Receive(&huart4, rx_data, 10, 10000);
//	  HAL_UART_Transmit(&huart4, rx_data, 10, 100);
